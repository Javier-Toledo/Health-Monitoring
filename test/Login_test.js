...
describe('Registro y autenticación de usuarios', () => {
  ...
  describe("Registrar usuario",() => {
    ...
    it("Debe registrar nuevo usuario", (done) => {
      ...
      .send({
        firtsName: "Pedro",
        lastNames: "Alatriste",
        email: "alatriste0107883@gmail.com",
        password: "Toledo1008",
        workstation: "Médico",
        occupation: "cirujano",
    ...
    it("Debe rechazar registrar usuario sin contraseña", (done) => {
      chai.request(url)
      .post('/users')
      .send({
        firtsName: "Pedro",
        lastNames: "Alatriste",
        email: "toledo@hydn.com",
        password: "",
        workstation: "Médico",
        occupation: "cirujano",
        area: "Medicina General",
  ...
  describe("Validar cuenta de usuario",() => {
    ...
    it("Debe permitir validar cuenta de usuario", (done) => {
      ...
      .send({
        token: '$2b$10$rVBUvann22el9xH0HSbcYe9wdpVGUfZbTbhJGaaSQ1pVzic.cRFE6'
      })
      .end(function(err, res){
        expect(res).to.have.status(200);
        expect(res.body).to.have.property('message');
